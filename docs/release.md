...
8.  Ensure the new [backend](https://hub.docker.com/r/lasuite/drive-frontend/tags) and [frontend](https://hub.docker.com/r/lasuite/drive-frontend/tags) image tags are on Docker Hub.
