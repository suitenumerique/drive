...
4. Commit the changes and create a PR named "🔖(release) version sdk package".

5. Run `npm publish`. It will publish the new version of the package to NPM and create a git tag.
