...
def test_services_search_indexers_serialize_document_returns_expected_json():
    ...
    item = factories.ItemFactory(
        upload=b"This is a text file content",
        mimetype="text/plain",
    )
...
def test_services_search_indexers_serialize_document_deleted():
    ...
    folder = factories.ItemFactory(type=models.ItemTypeChoices.FILE)
    item = factories.DocumentFactory(parent=folder, mimetype="text/plain")
...
def test_services_search_indexers_serialize_document_empty():
    ...
    item = factories.ItemFactory(title=None, mimetype="text/plain")
...
def test_services_search_indexers_batches_pass_only_batch_accesses(
    ...
    items = factories.ItemFactory(
        upload=b"This is a text document",
        mimetype="text/plain",
...
def test_services_search_indexers_ignore_empty_documents(mock_push):
    ...
    """
    item = factories.ItemFactory(
        upload=b"This is a text file",
        upload_state=models.ItemUploadStateChoices.READY,
    )
    empty_title = factories.DocumentFactory(
        upload=b"This is a text file",
        title="",
        upload_state=models.ItemUploadStateChoices.READY,
    )
    ...
    # completely empty
    factories.ItemFactory(title="", upload_state=models.ItemUploadStateChoices.READY)
    ...
    # Make sure only not empty documents are indexed
