...
def test_items_api_anonymous_to_a_public_tree_structure():
    ...
    assert response.json() == {
        ...
        "children": [
            {
                ...
                "numchild": 0,
                "numchild_folder": 0,
                "path": f"{root.id!s}.{level1_2.id!s}.{level2_1.id!s}",
                "title": "level2_1",
                "type": level2_1.type,
            ...
            },
            {
                ...
                "numchild": 0,
                "numchild_folder": 0,
                "path": f"{root.id!s}.{level1_2.id!s}.{level2_2.id!s}",
                "title": "level2_2",
                "type": level2_2.type,
        ...
        "numchild": 2,
        "numchild_folder": 2,
        "path": f"{root.id!s}.{level1_2.id!s}",
        "title": "level1_2",
        "type": level1_2.type,
...
def test_items_api_tree_authenticated_direct_access(django_assert_num_queries):
    ...
    assert response.json() == {
        ...
        "children": [
            {
                ...
                "children": [
                    {
                        ...
                        "url_preview": None,
                        "mimetype": None,
                        "user_role": level2_1.item.get_role(user),
                        "main_workspace": False,
                    ...
                    },
                    {
                        ...
                        "children": [
                            {
                                ...
                                "numchild_folder": 0,
                                "path": (
                                    f"{root.item.id!s}.{level1_1.item.id!s}.{level2_2.item.id!s}."
                                    f"{level3_1.item.id!s}"
                                ),
                                "title": "level3_1",
                                ...
                                "url_preview": None,
                                "mimetype": None,
                                "user_role": level3_1.item.get_role(user),
                                "main_workspace": False,
                        ...
                        "url_preview": None,
                        "mimetype": None,
                        "user_role": level2_2.item.get_role(user),
                        "main_workspace": False,
                ...
                "url_preview": None,
                "mimetype": None,
                "user_role": level1_1.item.get_role(user),
                "main_workspace": False,
            ...
            },
            {
                ...
                "url_preview": None,
                "mimetype": None,
                "user_role": level1_2.item.get_role(user),
                "main_workspace": False,
            ...
            },
            {
                ...
                "url_preview": None,
                "mimetype": None,
                "user_role": level1_3.item.get_role(user),
                "main_workspace": False,
        ...
        "url_preview": None,
        "mimetype": None,
        "user_role": root.item.get_role(user),
        "main_workspace": True,
...
def test_api_items_tree_authenticated_with_access_authenticated():
    ...
    assert response.json() == {
        ...
        "numchild": 2,
        "numchild_folder": 2,
        "path": f"{root.id!s}.{level1_1.id!s}",
        "title": "level1_1",
        "type": "folder",
        ...
        "children": [
            {
                ...
                "numchild": 0,
                "numchild_folder": 0,
                "path": f"{root.id!s}.{level1_1.id!s}.{level2_1.id!s}",
                "title": "level2_1",
                "type": "folder",
                "updated_at": level2_1.updated_at.isoformat().replace("+00:00", "Z"),
                "upload_state": None,
            ...
            },
            {
                ...
                "numchild": 4,
                "numchild_folder": 0,
                "path": f"{root.id!s}.{level1_1.id!s}.{level2_2.id!s}",
                "title": "level2_2",
                "type": "folder",
                "updated_at": level2_2.updated_at.isoformat().replace("+00:00", "Z"),
                "upload_state": None,
