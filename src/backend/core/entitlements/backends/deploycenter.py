...
class DeployCenterEntitlementsBackend(EntitlementsBackend):
    ...
    def __init__(self, base_url, service_id, api_key, timeout=10, oidc_claims=None):
    ...
    def fetch_entitlements(self, user):
        ...
        params = {
            "account_type": "user",
            "account_id_key": "email",
            "account_id_value": user.email,
    ...
    def get_entitlements(self, user):
        ...
        try:
            ...
            raise
        cache.set(cache_key, entitlements, timeout=self.timeout)
        return entitlements
