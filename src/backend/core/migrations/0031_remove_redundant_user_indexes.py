...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                # The names come from Django's names_digest(table, column). With
                # IF EXISTS a renamed index would make the drop a silent no-op;
                # core.tests.test_migrations asserts the final state instead.
